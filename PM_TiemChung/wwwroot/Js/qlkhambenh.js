    ...
    gr.forEach(function (item) {
        $('#tbody-tableThuNhan').append(`<tr class="bg-azure-lt">
                                                    <td class="px-2 py-1 text-center">
                                                        <button class="btn btn-icon bg-green-lt btn-print-thungan" value="${item.idbnNavigation.id}" data-bs-toggle="tooltip" data-bs-placement="left" title="Sửa">
        ...
        item.datas.forEach(function (lt, i) {
            ...
            $('#tbody-tableThuNhan').append(`<tr>
                                                        ...
                                                        <td class="text-center last-td-column px-1">
                                                            <button class="btn btn-icon bg-azure-lt btn-save-thungan" ${lt.daThu == true ? "disabled" : ""} value="${lt.id}" data-bs-toggle="tooltip" data-bs-placement="left" title="Sửa">
...
function renderTableTiemChung(datas) {
    ...
    datas.forEach(function (lt, index) {
        ...
        $('#tbody-tiemchung').append(`<tr>
                                                    ...
                                                    <td class="text-center last-td-column px-2">
                                                        <button value="${lt.id}" disabled class="btn btn-icon bg-azure-lt btn-save-tiemchung" data-bs-toggle="tooltip" data-bs-placement="left" title="Tiêm chủng">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-device-floppy" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M6 4h10l4 4v10a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2" /><path d="M12 14m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M14 4l0 4l-6 0l0 -4" /></svg>
                                                        </button>
                                                    </td>
                                                </tr>`);
