...
$(document).ready(function () {
    ...
    $('#formUpdate').submit(function (event) {
        ...
        if (!form.checkValidity()) {
            ...
            $.ajax({
                url: '/DanhMuc/DM_XaCuTru/update', // Đường dẫn đến action xử lý form
                method: 'POST',
                data: formData,
    ...
    $(document).on('click', '#btnDanger', function () {
        $.ajax({
            type: "post",
            url: "/DanhMuc/DM_XaCuTru/changeActive",
            data: "id=" + idModel,
            success: function (response) {
                if (response.statusCode == 200) {
...
function getRowTable(data) {
    ...
    <td class="text-center MaXa">${data.maXa == null ? "" : data.maXa}</td>
    <td class="text-start TenXa">${data.tenXa == null ? "" : data.tenXa}</td>
    <td class="text-start Idquan">${data.idquanNavigation.tenQuan == null ? "" : data.idquanNavigation.tenQuan}</td>
    <td class="text-start Idtinh">${data.idquanNavigation.idtinhNavigation.tenTinh == null ? "" : data.idquanNavigation.idtinhNavigation.tenTinh}</td>
...
function changePage(pageNumber) {
    ...
    $.ajax({
        type: "post",
        url: "/DanhMuc/DM_XaCuTru/changePage",
...
function searchWithKeyword() {
    ...
    if (key == "") {
        $.ajax({
            type: "post",
            url: "/DanhMuc/DM_XaCuTru/api/getModelsWithNumberPage",
            success: function (response) {
                dataResponse = [];
                hideProgress();
                updateDataOfTable(response.result);
        ...
        $.ajax({
            type: "post",
            url: "/DanhMuc/DM_XaCuTru/api/searchWithKeyword",
...
function showModal(id) {
    $.ajax({
        type: "post",
        url: "/DanhMuc/DM_XaCuTru/showModal",
        data: "id=" + id,
        success: function (response) {
